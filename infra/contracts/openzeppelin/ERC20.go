...
// DeployERC20 deploys a new Conflux contract, binding an instance of ERC20 to it.
func DeployERC20(auth *bind.TransactOpts, backend bind.ContractBackend, name_ string, symbol_ string) (*types.UnsignedTransaction, *types.Hash, *ERC20, error) {
	parsed, err := abi.JSON(strings.NewReader(ERC20ABI))
	if err != nil {
		return nil, nil, nil, err
	}

	tx, hash, contract, err := bind.DeployContract(auth, parsed, common.FromHex(ERC20Bin), backend, name_, symbol_)
	if err != nil {
		return nil, nil, nil, err
	}
	return tx, hash, &ERC20{ERC20Caller: ERC20Caller{contract: contract}, ERC20Transactor: ERC20Transactor{contract: contract}, ERC20Filterer: ERC20Filterer{contract: contract}}, nil
}
...
func (_ERC20 *ERC20Caller) Decimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	__err := _ERC20.contract.Call(opts, &out, "decimals")
...
//
// Solidity: function decimals() view returns(uint8)
func (_ERC20 *ERC20BulkCaller) Decimals(bulkcaller bulk.BulkCaller, opts *bind.CallOpts) (*uint8, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _ERC20.contract.GenRequest(opts, "decimals")
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC20.contract.DecodeOutput(&out, rawOut, "decimals")
		if err != nil {
			return err
		}
...
func (_ERC20 *ERC20Caller) Name(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	__err := _ERC20.contract.Call(opts, &out, "name")
...
//
// Solidity: function name() view returns(string)
func (_ERC20 *ERC20BulkCaller) Name(bulkcaller bulk.BulkCaller, opts *bind.CallOpts) (*string, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _ERC20.contract.GenRequest(opts, "name")
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC20.contract.DecodeOutput(&out, rawOut, "name")
		if err != nil {
			return err
		}
...
func (_ERC20 *ERC20Caller) Symbol(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	__err := _ERC20.contract.Call(opts, &out, "symbol")
...
//
// Solidity: function symbol() view returns(string)
func (_ERC20 *ERC20BulkCaller) Symbol(bulkcaller bulk.BulkCaller, opts *bind.CallOpts) (*string, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _ERC20.contract.GenRequest(opts, "symbol")
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC20.contract.DecodeOutput(&out, rawOut, "symbol")
		if err != nil {
			return err
		}
...
func (_ERC20 *ERC20Transactor) DecreaseAllowance(opts *bind.TransactOpts, spender common.Address, subtractedValue *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ERC20 *ERC20BulkTransactor) DecreaseAllowance(opts *bind.TransactOpts, spender common.Address, subtractedValue *big.Int) types.UnsignedTransaction {
	return _ERC20.contract.GenUnsignedTransaction(opts, "decreaseAllowance", spender, subtractedValue)
}

// DecreaseAllowance is a paid mutator transaction binding the contract method 0xa457c2d7.
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ERC20 *ERC20Session) DecreaseAllowance(spender common.Address, subtractedValue *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ERC20 *ERC20TransactorSession) DecreaseAllowance(spender common.Address, subtractedValue *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
	return _ERC20.Contract.DecreaseAllowance(&_ERC20.TransactOpts, spender, subtractedValue)
}
...
func (_ERC20 *ERC20Transactor) IncreaseAllowance(opts *bind.TransactOpts, spender common.Address, addedValue *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ERC20 *ERC20BulkTransactor) IncreaseAllowance(opts *bind.TransactOpts, spender common.Address, addedValue *big.Int) types.UnsignedTransaction {
	return _ERC20.contract.GenUnsignedTransaction(opts, "increaseAllowance", spender, addedValue)
}

// IncreaseAllowance is a paid mutator transaction binding the contract method 0x39509351.
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ERC20 *ERC20Session) IncreaseAllowance(spender common.Address, addedValue *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ERC20 *ERC20TransactorSession) IncreaseAllowance(spender common.Address, addedValue *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
	return _ERC20.Contract.IncreaseAllowance(&_ERC20.TransactOpts, spender, addedValue)
}
...
func (_ERC20 *ERC20Transactor) Transfer(opts *bind.TransactOpts, to common.Address, amount *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function transfer(address to, uint256 amount) returns(bool)
func (_ERC20 *ERC20BulkTransactor) Transfer(opts *bind.TransactOpts, to common.Address, amount *big.Int) types.UnsignedTransaction {
	return _ERC20.contract.GenUnsignedTransaction(opts, "transfer", to, amount)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address to, uint256 amount) returns(bool)
func (_ERC20 *ERC20Session) Transfer(to common.Address, amount *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function transfer(address to, uint256 amount) returns(bool)
func (_ERC20 *ERC20TransactorSession) Transfer(to common.Address, amount *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
	return _ERC20.Contract.Transfer(&_ERC20.TransactOpts, to, amount)
}
...
func (_ERC20 *ERC20Transactor) TransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, amount *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function transferFrom(address from, address to, uint256 amount) returns(bool)
func (_ERC20 *ERC20BulkTransactor) TransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, amount *big.Int) types.UnsignedTransaction {
	return _ERC20.contract.GenUnsignedTransaction(opts, "transferFrom", from, to, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 amount) returns(bool)
func (_ERC20 *ERC20Session) TransferFrom(from common.Address, to common.Address, amount *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function transferFrom(address from, address to, uint256 amount) returns(bool)
func (_ERC20 *ERC20TransactorSession) TransferFrom(from common.Address, to common.Address, amount *big.Int) (*types.UnsignedTransaction, *types.Hash, error) {
	return _ERC20.Contract.TransferFrom(&_ERC20.TransactOpts, from, to, amount)
}
